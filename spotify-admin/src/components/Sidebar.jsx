    ...
    <div className="bg-[#003A10] min-h-screen pl-[4vw]">
      ...
      <div className="flex flex-col gap-5 mt-10 ">
        ...
        <NavLink
          ...
          className="flex items-center gap-2.5 text-gray-800 bg-white border border-black p-2 pr-[max(8vw,10px)] drop-shadow-[-4px_4px_#00FF5B] text-sm font-medium"
        >
          <img src={assets.add_podcaster} className="w-5" alt="" />
          <p className="hidden sm:block">Add Podcaster</p>
        </NavLink>
        <NavLink
          to="/add-podcast"
          className="flex items-center gap-2.5 text-gray-800 bg-white border border-black p-2 pr-[max(8vw,10px)] drop-shadow-[-4px_4px_#00FF5B] text-sm font-medium"
        >
          <img src={assets.add_podcast} className="w-5" alt="" />
        ...
        <NavLink
          ...
          className="flex items-center gap-2.5 text-gray-800 bg-white border border-black p-2 pr-[max(8vw,10px)] drop-shadow-[-4px_4px_#00FF5B] text-sm font-medium"
        >
          <img src={assets.list_artist} className="w-5" alt="" />
        ...
        <NavLink
          ...
          className="flex items-center gap-2.5 text-gray-800 bg-white border border-black p-2 pr-[max(8vw,10px)] drop-shadow-[-4px_4px_#00FF5B] text-sm font-medium"
        >
          <img src={assets.list_podcaster} className="w-5" alt="" />
          <p className="hidden sm:block">List Podcaster</p>
        </NavLink>
        <NavLink
          to="/list-podcast"
          className="flex items-center gap-2.5 text-gray-800 bg-white border border-black p-2 pr-[max(8vw,10px)] drop-shadow-[-4px_4px_#00FF5B] text-sm font-medium"
        >
          <img src={assets.list_podcast} className="w-5" alt="" />
